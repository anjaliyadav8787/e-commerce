...
export default function AdminLogin2() {
  let {setPass} = useContext(UserContext)
   let navigation = useNavigate()
    ...
    let {adminemail,adminpassword } = data
    ...
    async function handleLogin2(e){
      ...
      let result  = await axios.post('http://localhost:3000/api/adminLogin2', data)
    ...
    <section>
      <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <form action="#" method="POST" className="mt-8" onSubmit={handleLogin2}>
