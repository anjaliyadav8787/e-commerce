...
export default function Home() {
  ...
  return (
   <>
    <aside className="fixed flex h-screen w-64 flex-col overflow-y-auto border-r bg-black px-5 py-8 mt-10">
      
      <div className="mt-6 flex flex-1 flex-col justify-between">
        <nav className="-mx-3 space-y-6 ">
          <div className="space-y-3 ">
            <label className=" text-4xl text-xs font-semibold uppercase text-white">Search</label> 
    ...
    <div class="relative">
        ...
        placeholder="Search Product By Type..." required onClick={handleSearch} />
        {/* <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button> */}
    </div>
</form>

<button className='p-1 bg-gray-200 rounded-[10px] text-x1 font-bold hover:bg-gray-500 hover:text-white bg-white	'
...
{/* card section strat here */}
    <div className='relative  left-[300px] top-[40px] flex justify-evenly w-[1100px] flex-wrap'>
    {data.map((data)=>(
        <div className="w-[320px] rounded-md border bg-black text-2xl text-white mt-10">
        <img
          src={`http://localhost:3000/${data.image}`}
          className="h-[370px] w-[400px] rounded-t-md object-cover "
        />
        <div className="p-4">
          ...
          <button
            ...
            className="mt-4 w-full rounded-sm bg-white px-2 py-1.5 text-sm font-semibold text-black shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Add To Cart
          </button>
        </div>
